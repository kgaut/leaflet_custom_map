...
namespace Drupal\leaflet_custom_map\Entity\ListBuilder;
...
/**
 * Provides a list controller for the map background entity type.
 */
class MapBackgroundListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new MapBackgroundListBuilder object.
   *
